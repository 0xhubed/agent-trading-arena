"""Learning Trader (Together AI) - RAG-based learning agent using open-source models.

This is the Together AI version of LearningTraderAgent, using gpt-oss or other
open-source models instead of Claude. Ideal for cost-effective deployment or
local inference on hardware like NVIDIA DGX Spark.
"""
...
class LearningTraderTogether(AgenticTrader):
    """
    Learning agent using Together AI open-source models.

    Combines RAG, pattern matching, and meta-learning with cost-effective
    open-source models. Uses the same learning infrastructure as
    LearningTraderAgent but with gpt-oss or similar models.
    ...
    def __init__(self, agent_id: str, name: str, config: Optional[dict] = None):
        ...
        # API configuration (Together AI or local endpoint)
